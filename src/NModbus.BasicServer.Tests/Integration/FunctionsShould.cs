...
public class FunctionsShould : ClientServerTestBase
{
    ...
    public async Task WriteMultipleRegistersShouldWork(ushort startingAddress)
    {
        ...
        await clientServer.Client.WriteMultipleRegistersAsync(clientServer.UnitIdentifier, startingAddress,
    ...
    public async Task ReadHoldingRegistersShouldWork(ushort startingAddress, ushort[] values)
    {
        ...
        var registers = await clientServer.Client.ReadHoldingRegistersAsync(clientServer.UnitIdentifier,
            startingAddress, (ushort)values.Length);
    ...
    public async Task ReadInputRegistersShouldWork(ushort startingAddress, ushort[] values)
    {
        ...
        var registers = await clientServer.Client.ReadInputRegistersAsync(clientServer.UnitIdentifier, startingAddress,
