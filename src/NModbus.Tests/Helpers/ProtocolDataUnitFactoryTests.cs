...
{
    [Theory]
    [InlineData(ModbusFunctionCodes.READ_HOLDING_REGISTERS, ModbusExceptionCode.IllegalDataAddress,
        new byte[] { 0b10000000 | 0x03, (byte)ModbusExceptionCode.IllegalDataAddress })]
