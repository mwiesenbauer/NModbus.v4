...
public class
    ReadInputRegistersImplementation : IModbusFunctionImplementation<ReadInputRegistersRequest,
    ReadInputRegistersResponse>
{
    ...
    public Task<ReadInputRegistersResponse> ProcessAsync(ReadInputRegistersRequest request,
