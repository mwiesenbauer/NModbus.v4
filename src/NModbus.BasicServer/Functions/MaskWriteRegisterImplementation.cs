    ...
    : IModbusFunctionImplementation<MaskWriteRegisterRequest, MaskWriteRegisterResponse>
{
    ...
    public Task<MaskWriteRegisterResponse> ProcessAsync(MaskWriteRegisterRequest request,
        CancellationToken cancellationToken)
    {
        ...
        return Task.FromResult(new MaskWriteRegisterResponse(request.ReferenceAddress, request.AndMask,
            request.OrMask));
    }
