...
public class
    ReadHoldingRegistersImplementation : IModbusFunctionImplementation<ReadHoldingRegistersRequest,
    ReadHoldingRegistersResponse>
{
    ...
    public Task<ReadHoldingRegistersResponse> ProcessAsync(ReadHoldingRegistersRequest request,
