...
public class
    WriteSingleCoilImplementation : IModbusFunctionImplementation<WriteSingleCoilRequest, WriteSingleCoilResponse>
{
    ...
    public Task<WriteSingleCoilResponse> ProcessAsync(WriteSingleCoilRequest request,
