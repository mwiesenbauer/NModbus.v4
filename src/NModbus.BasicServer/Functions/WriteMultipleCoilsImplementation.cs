...
public class
    WriteMultipleCoilsImplementation : IModbusFunctionImplementation<WriteMultipleCoilsRequest,
    WriteMultipleCoilsResponse>
{
    ...
    public Task<WriteMultipleCoilsResponse> ProcessAsync(
    ...
    )
    {
        ...
        return Task.FromResult(new WriteMultipleCoilsResponse(request.StartingAddress,
            (ushort)request.OutputsValue.Length));
    }
}
